    ...
    <div class="row">
      <div class="col-lg-6 col-md-12 customer_info form_section">
        ...
        <div class="col-lg-12 col-md-12 form-group">
          ...
          <div class="col-lg-12 col-md-12 form-group">
              <input  placeholder="Stripe id" class="form-control  @error('stripe_id') is-invalid @enderror" id="stripe_id" name="stripe_id" type="text" value="{{(isset($user->stripe_id)?$user->stripe_id:'')}}" required>
