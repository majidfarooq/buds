  ...
  <div class="card h-100 customer_create_form">
    ...
    <div class="row">
      <div class="col-lg-6 col-md-12 customer_info form_section">
        ...
        <div class="col-lg-12 col-md-12 form-group">
          <input  placeholder="Business Name" class="form-control  @error('business_name') is-invalid @enderror" id="business_name" name="business_name" type="text" value="{{(isset($user->business_name)?$user->business_name:'')}}">
        </div>
        <div class="col-lg-12 col-md-12 form-group">
        ...
        <div class="col-lg-12 col-md-12 form-group">
          ...
          <div class="col-lg-12 col-md-12 form-group">
              <input  placeholder="Stripe id" class="form-control  @error('stripe_id') is-invalid @enderror" id="stripe_id" name="stripe_id" type="text" value="{{(isset($user->stripe_id)?$user->stripe_id:'')}}">
          </div>
      </div>
    ...
    <div class="row">
      <div class="col-lg-6 col-md-12 billing_address form_section">
        ...
        <div class="col-lg-12 col-md-12 form-group">
          <input type="hidden" name="billing_coordinates" id="billing_coordinates" value="{{(isset($user->billing_coordinates)?$user->billing_coordinates:'')}}">
            <input type="hidden" name="billing_lat" id="billing_lat" value="{{(isset($user->billing_lat)?$user->billing_lat:'')}}">
            <input type="hidden" name="billing_long" id="billing_long" value="{{(isset($user->billing_long)?$user->billing_long:'')}}">
      ...
      <div class="col-lg-6 col-md-12 delivery_address form_section">
        <div class="col-lg-12 col-md-12">
        <h2>Delivery Address <span>Same as Billing Address</span><input type="checkbox" name="same_as_billing_address" id="same_as_billing_address" {{($user->billing_coordinates == $user->delivery_coordinates)? "checked" : ""}} >
        </h2>
        </div>
        <div class="col-lg-12 col-md-12 form-group">
          <input type="hidden" name="delivery_coordinates" id="delivery_coordinates" value="{{(isset($user->delivery_coordinates)?$user->delivery_coordinates:'')}}">
            <input type="hidden" name="delivery_lat" id="delivery_lat"  value="{{(isset($user->delivery_lat)?$user->delivery_lat:'')}}">
            <input type="hidden" name="delivery_long" id="delivery_long"  value="{{(isset($user->delivery_long)?$user->delivery_long:'')}}">
          <input  placeholder="Address 1" required  class="form-control @error('delivery_address1') is-invalid @enderror" id="delivery_address1" name="delivery_address1" type="text" value="{{(isset($user->delivery_address1)?$user->delivery_address1:'')}}" {{($user->billing_coordinates == $user->delivery_coordinates)? "disabled" : ""}}>
          @error('delivery_address1') <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span> @enderror
        </div>
        <div class="col-lg-12 col-md-12 form-group">
          <input  placeholder="Address 2"  class="form-control @error('delivery_address2') is-invalid @enderror" id="delivery_address2" name="delivery_address2" type="text" value="{{(isset($user->delivery_address2)?$user->delivery_address2:'')}}" {{($user->billing_coordinates == $user->delivery_coordinates)? "disabled" : ""}}>
          @error('delivery_address2') <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span> @enderror
        </div>
        <div class="col-lg-12 col-md-12 form-group">
          <input  required placeholder="City"  class="form-control @error('delivery_city') is-invalid @enderror" id="delivery_city" name="delivery_city" type="text" value="{{(isset($user->delivery_city)?$user->delivery_city:'')}}" {{($user->billing_coordinates == $user->delivery_coordinates)? "disabled" : ""}}>
          @error('delivery_city') <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span> @enderror
        </div>
        <div class="col-lg-12 col-md-12 form-group">
          <input  required placeholder="CA" class="form-control @error('delivery_state') is-invalid @enderror" id="delivery_state" name="delivery_state" type="text" value="{{(isset($user->delivery_state)?$user->delivery_state:'')}}" {{($user->billing_coordinates == $user->delivery_coordinates)? "disabled" : ""}}>
          @error('delivery_state') <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span> @enderror
        </div>
        <div class="col-lg-12 col-md-12 form-group">
          <input required placeholder="12345" class="form-control @error('delivery_zip') is-invalid @enderror" id="delivery_zip" name="delivery_zip" type="text" value="{{(isset($user->delivery_zip)?$user->delivery_zip:'')}}" {{($user->billing_coordinates == $user->delivery_coordinates)? "disabled" : ""}}>
