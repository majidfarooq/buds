    ...
    <div class="card shadow mb-4">
      ...
      <div class="card-body">
        <div class="col-12 p-0">
          <div class="row m-0">
            {!! Form::open(["route" => ["admin.categories.update",$category->slug],"files"=> true,"class"=>"w-100","method"=>"Post"]) !!}
            <div class="col-md-12">
            ...
            <div class="col-md-12">
              <div class="form-group">
                ...
                <textarea name="description"
                      ...
                      rows="10">{{(isset($category->description)?$category->description:'')}}</textarea>
                @error('description')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="col-md-12">
              <div class="form-group">
                ...
                <div class="w-100">
                  <img width="100" src="{{(isset($category->image) ? asset($category->image) : asset('/public/storage/placeholder.jpg'))}}" alt="current image"
                     id="category_image">
                </div>
              </div>
            </div>
...
{{--                    <option value="{{$cat->id}}"--}}
{{--                    @isset($category->parent) {{ $category->parent->id === $cat->id ? 'selected' : '' }}@endisset> {{$cat->name}}</option>--}}
{{--                  @endforeach--}}
{{--                </select>--}}
{{--              </div>--}}
{{--            </div>--}}
